# Mew Assistant - Project Management

## Table of Contents
1. [Governance Recommendations](#governance-recommendations)
2. [Non-Profit Setup](#non-profit-setup)
3. [Transition Plan](#transition-plan)
4. [Transition Checklist](#transition-checklist)
