...
az keyvault secret set \
  ...
  --name "database-url" \
  --value "postgresql://mewadmin:REDACTED-DB-PASSWORD@mew-assistant-db.postgres.database.azure.com:5432/mew_assistant?sslmode=require"
...
az keyvault secret set \
  ...
  --value "REDACTED-GOOGLE-CLIENT-SECRET"
...
az keyvault secret set \
  ...
  --value "REDACTED-MICROSOFT-CLIENT-SECRET"
