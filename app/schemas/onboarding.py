...
class QuickRegistrationRequest(BaseModel):
    ...
    identifier: str = Field(..., description="Email, phone number, or device ID")
...
class MagicLinkRequest(BaseModel):
    ...
    additional_info: Optional[Dict[str, Any]] = Field(
        default_factory=dict, description="Any additional info to complete profile"
    )
...
class VoiceRegistrationRequest(BaseModel):
    ...
    platform: str = Field(..., description="Voice platform: siri, alexa, grok, google_assistant, etc.")
    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "name": "John Doe",
                "profile_data": {"picture": "https://...", "locale": "en-US"},
            }
        }
...
class FamilySetupRequest(BaseModel):
    ...
    family_data: Dict[str, Any] = Field(..., description="Family configuration")
...
class OnboardingResponse(BaseModel):
    ...
    status: str = Field(..., description="Status: pending, success, existing_user, recognized, etc.")
    message: str = Field(..., description="Human-readable message")
    user_id: Optional[int] = None
    family_id: Optional[int] = None
    next_step: Optional[str] = Field(None, description="Next onboarding step: family_setup, verify_email, etc.")
