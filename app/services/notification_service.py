...
class NotificationService:
    ...
    def notify_parent_approval_needed(self, parent_id: int = None, kid_name: str = None, request_id: str = None, details: Dict[str, Any] = None, **kwargs) -> bool:
        """
    ...
    def notify_kid_request_approved(self, kid: Any = None, request: Any = None, parent_note: Optional[str] = None, **kwargs) -> bool:
    ...
    def notify_kid_request_denied(self, kid: Any = None, request: Any = None, parent_note: Optional[str] = None, alternative: Optional[str] = None, **kwargs) -> bool:
    ...
    def notify_parent_of_kid_concern(self, parent_id: int = None, kid_id: int = None, concern: str = None, **kwargs) -> bool:
    ...
    def notify_parent_help_request(self, parent_id: int = None, kid_id: int = None, details: Dict[str, Any] = None, **kwargs) -> bool:
