...
class NotFoundError(MewException):
    ...
    def __init__(self, resource: str, identifier: str):
        ...
        super().__init__(message, status_code=404, error_code="RESOURCE_NOT_FOUND", details={"resource": resource, "identifier": identifier})
...
class RateLimitError(MewException):
    ...
    def __init__(self, retry_after: int):
        ...
        super().__init__(message, status_code=429, error_code="RATE_LIMIT_EXCEEDED", details={"retry_after": retry_after})
...
class CooldownError(MewException):
    ...
    def __init__(self, remaining_seconds: int):
        ...
        super().__init__(message, status_code=429, error_code="COOLDOWN_ACTIVE", details={"cooldown_remaining": remaining_seconds})
