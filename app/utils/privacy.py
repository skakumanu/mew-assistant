...
class DataAnonymizer:
    ...
    def anonymize_text(cls, text: str) -> str:
        ...
        text = re.sub(r'\b(SID|STUDENT[_\s]?ID)[:\s]?\d{6,}\b', 'SID******', text, flags=re.IGNORECASE)
...
class PrivacyGuardrails:
    ...
    def scan_and_protect(self, data: Dict[str, Any], 
    ...
    def validate_data_minimization(self, collected_fields: List[str],
