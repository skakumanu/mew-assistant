...
$config.properties.template.containers[0].env[$dbUrlIndex].value = "postgresql://mewadmin:REDACTED-DB-PASSWORD@mew-assistant-db.postgres.database.azure.com:5432/mew_assistant"
